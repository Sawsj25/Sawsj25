...
if (isset($_GET['id'])) {
    if (!empty($_POST)) {
        ...
        $msg = "<script>alert('update')</script>";
    }
...
<div class="content update">
    ...
    <form action="update.php?id=<?=$contact['id']?>" method="post">
        ...
        <input type="text" name="email" placeholder="johndoe@gmail.com" value="<?=$contact['email']?>" id="email">
        <input type="text" name="phone" placeholder="98" value="<?=$contact['phone']?>" id="phone">
